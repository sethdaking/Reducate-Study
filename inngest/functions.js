      ...
      const aiResponse = await step.run("Generate Content", async () => {
        ...
        if (studyType === "flashcards") {
          ...
          prompt = `
            ...
            9. Write understandable english for human beings with no errors
            10. Does not include letters for the options in the text for the possible answers
            11. Uses <strong className='text-xl'> for emphasis in the question and anwer
            ...
            14. Make the questions REALLY HARD but based on the material provided
            15. Make sure the text is readable with no spelling errors or grammatical errors
          `;
